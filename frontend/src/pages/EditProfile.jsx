      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-xl w-full relative">
        ...
        <form  className="space-y-5" onSubmit={(e)=>e.preventDefault()}>
          ...
          {userData.photoUrl ? <img
            src={getFullUrl(userData?.photoUrl)}
            alt=""
         ...
         {userData?.name.slice(0,1).toUpperCase()}
          ...
          <button
            type="submit"
            className="w-full shimmer-btn bg-gradient-to-r from-violet-600 to-fuchsia-500 active:scale-[0.98] text-white py-2.5 rounded-xl font-semibold transition-all cursor-pointer hover:shadow-lg hover:shadow-violet-300" disabled={loading} onClick={updateProfile}
          >
