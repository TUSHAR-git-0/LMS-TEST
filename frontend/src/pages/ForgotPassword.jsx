     ...
     { step==1 && <div className="bg-white shadow-md rounded-xl p-8 max-w-md w-full">
        <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">
          ...
          <form  className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full shimmer-btn bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white py-2.5 px-4 rounded-xl font-semibold cursor-pointer hover:shadow-lg hover:shadow-violet-300 transition-all active:scale-95" disabled={loading} onClick={handleStep1}
            >
      ...
      {step==2 && <div className="bg-white shadow-lg rounded-xl p-8 max-w-md w-full">
        ...
        {/* OTP Inputs */}
          ...
          <form  className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full shimmer-btn bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white py-2.5 px-4 rounded-xl font-semibold cursor-pointer hover:shadow-lg hover:shadow-violet-300 transition-all active:scale-95" disabled={loading} onClick={handleStep2} 
            >
      ...
      {step==3 &&   <div className="bg-white shadow-lg rounded-xl p-8 max-w-md w-full">
        ...
        <form className="space-y-5" onSubmit={(e)=>e.preventDefault()}>
          ...
          <button
            type="submit"
            className="w-full shimmer-btn bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white py-2.5 rounded-xl font-semibold cursor-pointer hover:shadow-lg hover:shadow-violet-300 transition-all active:scale-95" onClick={handleStep3}
          >
