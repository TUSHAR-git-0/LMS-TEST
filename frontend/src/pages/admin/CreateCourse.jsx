        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-10">
            <div className="max-w-xl w-[600px] mx-auto p-6 bg-white shadow-md rounded-md mt-10 relative">
                ...
                <form className="space-y-5" onSubmit={(e)=>e.preventDefault()}>
                    ...
                    <button
                        type="submit"
                        className="w-full shimmer-btn bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white py-2.5 px-4 rounded-xl font-semibold hover:scale-[1.01] hover:shadow-lg hover:shadow-violet-300 transition-all active:scale-95 cursor-pointer" disabled={loading} onClick={CreateCourseHandler}
                    >
