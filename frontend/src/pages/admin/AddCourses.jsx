...
function AddCourses() {
  ...
  if (selectedCourse) {
    ...
    setFrontendImage(getFullUrl(selectedCourse.thumbnail) || img)
     ...
     <div className="max-w-5xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md">
      ...
      <div className="flex items-center justify-center gap-[20px] md:justify-between flex-col md:flex-row  mb-6 relative">
        ...
        <div className="space-x-2 space-y-2 ">
          <button className="shimmer-btn bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white px-5 py-2.5 rounded-full font-medium hover:scale-105 hover:shadow-lg hover:shadow-violet-300 transition-all active:scale-95 cursor-pointer" onClick={()=>navigate(`/createlecture/${selectedCourse?._id}`)}>Go to lectures page</button>
      ...
      <div className="bg-gray-50 p-6 rounded-md">
        ...
        <div className="space-x-2 space-y-2 ">
          ...
          <button className="bg-red-600 text-white px-4 py-2 rounded-md" disabled={removeLoading} onClick={removeCourse}>{removeLoading?<ClipLoader size={30} color='white'/> :"Remove Course"}</button>
        </div>
        ...
        <form className="space-y-6" onSubmit={(e)=>e.preventDefault()}>
          ...
          <div className='flex items-center justify-start gap-[15px]'>
            ...
            <button className='shimmer-btn bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white px-7 py-2.5 rounded-full font-medium hover:scale-105 hover:shadow-lg hover:shadow-violet-300 transition-all active:scale-95 cursor-pointer' disabled={saveLoading} onClick={editCourseHandler}>{saveLoading ? <ClipLoader size={24} color='white'/> : "Save"}</button>
