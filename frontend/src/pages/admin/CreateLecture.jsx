     ...
     <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white shadow-xl rounded-xl w-full max-w-2xl p-6">
        ...
        <div className="flex gap-4 mb-6">
          ...
          <button className="shimmer-btn px-6 py-2.5 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white font-medium shadow-lg shadow-violet-200 hover:scale-105 hover:shadow-xl hover:shadow-violet-300 transition-all active:scale-95 cursor-pointer" disabled={loading} onClick={createLectureHandler}>
           {loading?<ClipLoader size={24} color='white'/>: "+ Create Lecture"}
          </button>
        </div>
