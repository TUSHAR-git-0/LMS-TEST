      ...
      <div className="w-full max-w-xl bg-white rounded-xl shadow-lg p-6 space-y-6">
        ...
        <div>
          ...
          <button className="mt-2 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-all text-sm" disabled={loading1} onClick={removeLecture}>
            {loading1?<ClipLoader size={24} color='white'/>:"Remove Lecture"}
          </button>
        </div>
        ...
        {/* Submit Button */}
        <div className="pt-4">
          <button className="w-full shimmer-btn bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white py-3 rounded-xl text-sm font-semibold hover:scale-[1.01] hover:shadow-lg hover:shadow-violet-300 transition-all active:scale-95 cursor-pointer" disabled={loading} onClick={editLecture}>
