    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="w-[100%] min-h-screen p-4 sm:p-6   bg-gray-100">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3 ">
          ...
          <button className="shimmer-btn bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white px-5 py-2.5 rounded-full font-medium hover:scale-105 hover:shadow-lg hover:shadow-violet-300 transition-all active:scale-95 cursor-pointer" onClick={() => navigate("/createcourses")}>
            Create Course
          </button>
        </div>
